...
const navigation=read('src/config/navigationGroups.js')
...
for(const page of ['system-audit','financial-reconciliation','backup','restore'])assert.match(navigation,new RegExp(page))
