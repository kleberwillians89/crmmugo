...
for(const token of ['composer-template','Enviar modelo','templateDrawerOpen','serviceWindowOpen===false','idempotencyKey',"status:'sending'",'mergeMessages'])assert.ok(page.includes(token),`Fluxo ausente: ${token}`)
