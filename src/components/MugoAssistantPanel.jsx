...
const suggestions = ['Quanto falta para bater a meta?', 'Quantos contratos precisamos para fazer 10 mil de Social Media?', 'Quais contratos vencem?', 'Quem devo ligar hoje?', 'Quais clientes podem comprar IA?', 'Qual serviço mais converte?', 'Como aumentar a receita este mês?', 'Quais propostas estão paradas?']
