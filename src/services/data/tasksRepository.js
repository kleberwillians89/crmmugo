...
const select='*, team_members(name), clients(company_name), proposals(title), contracts(contract_number), invoice_installments(reference_month), task_external_links(provider,external_url,sync_status,last_synced_at,last_error)'
